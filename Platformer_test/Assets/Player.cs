...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] float player_max_speed; 
    ...
    void Update()
    {
        ...
        #region jumping
            ...
            if(Input.GetKeyDown(KeyCode.Space))
            {
                ...
                //Allows an air jump if the player is not grouned and not in the middle of a jump
        ...
        #region dashing
            ...
            if(isDashing){
                player_rb2d.velocity = new Vector2(
                    (player_dash_speed * getPlayerDirection()), 0);
                ...
                if(player_dash_duration_timer >= player_dash_duration){
                    ...
                    player_rb2d.velocity = new Vector2(0, player_rb2d.velocity.y);
    ...
    private void FixedUpdate() {
        #region horizontal movement
            ...
            float moveSpeed = player_movement.x * player_max_speed;
